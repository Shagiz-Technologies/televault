        ...
        child: ResponsivePage(
          child: Column(
            ...
            children: [
              ...
              Gap(AppResponsive.gap(context, 24, compact: 12)),
              Icon(
                Icons.send_rounded,
                size: iconSize,
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final pinTheme = PinTheme(
                    ...
                    height: pinHeight,
                    textStyle: TextStyle(
                      fontSize: AppResponsive.isCompactHeight(context)
                          ? 20
                          : 24,
                      color: AppTheme.ink,
...
class _VerificationProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        _step('Account', true, Icons.check_rounded),
        const Expanded(child: Divider(indent: 8, endIndent: 8)),
        _step('Verify', true, Icons.looks_two_rounded),
        const Expanded(child: Divider(indent: 8, endIndent: 8)),
        _step('Ready', false, Icons.looks_3_rounded),
      ],
    );
  }

  Widget _step(String label, bool active, IconData icon) {
    return Column(
      children: [
        Container(
          width: 28,
          ...
          decoration: BoxDecoration(
            color: active ? AppTheme.primary : AppTheme.paperMuted,
        ...
        Text(
          label,
          style: TextStyle(
            color: active ? AppTheme.primaryDeep : AppTheme.inkMuted,
            fontSize: 10,
